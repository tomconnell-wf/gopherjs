...
var FS = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2022, 8, 16, 18, 10, 31, 731992222, time.UTC),
		},
		"/js": &vfsgen۰DirInfo{
			name:    "js",
			modTime: time.Date(2022, 8, 16, 17, 13, 39, 533037124, time.UTC),
		},
		"/js/js.go": &vfsgen۰CompressedFileInfo{
			name:             "js.go",
			modTime:          time.Date(2022, 8, 16, 17, 13, 39, 533226947, time.UTC),
		...
		"/js/js_test.go": &vfsgen۰CompressedFileInfo{
			name:             "js_test.go",
			modTime:          time.Date(2022, 7, 28, 18, 48, 56, 845071266, time.UTC),
		...
		"/nosync": &vfsgen۰DirInfo{
			name:    "nosync",
			modTime: time.Date(2020, 2, 20, 21, 0, 24, 522622677, time.UTC),
		},
		"/nosync/map.go": &vfsgen۰CompressedFileInfo{
			name:             "map.go",
			modTime:          time.Date(2020, 2, 20, 21, 0, 24, 522253990, time.UTC),
		...
		"/nosync/mutex.go": &vfsgen۰CompressedFileInfo{
			name:             "mutex.go",
			modTime:          time.Date(2020, 2, 20, 21, 0, 24, 522431020, time.UTC),
		...
		"/nosync/once.go": &vfsgen۰CompressedFileInfo{
			name:             "once.go",
			modTime:          time.Date(2020, 2, 20, 21, 0, 24, 522558512, time.UTC),
		...
		"/nosync/pool.go": &vfsgen۰CompressedFileInfo{
			name:             "pool.go",
			modTime:          time.Date(2020, 2, 20, 21, 0, 24, 522648878, time.UTC),
